...
public class CheckButton extends FrameLayout {
    ...
    public void setChecked(boolean checked) {
        ...
        showTv.setTextColor(getResources().getColor(checked ? R.color.theme_color : R.color.text_color_white));
    ...
    public void setOnRemindIcon(@DrawableRes int iconRes) {
        setOnRemindIcon(getResources().getDrawable(iconRes));
    }
    ...
    public void setOffRemindIcon(@DrawableRes int iconRes) {
        setOffRemindIcon(getResources().getDrawable(iconRes));
    }
